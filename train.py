...
import data as Data
from data.Load_dataset import LOLv1_Dataset, LOLv2_Dataset , pure_custom
...
def main():
    ...
    elif opt_dataset['dataset'] == 'pure_custom':
        dataset_cls = pure_custom
    else:
